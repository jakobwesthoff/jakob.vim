" Based on the PhpAlign function by Tobias Schlitt
" https://github.com/tobyS/vip
func! CodeAlign() range
    let l:paste = &g:paste
    let &g:paste = 0
...
" Map the alignment functionaly to <leader>a
vnoremap <buffer> <leader>a :call CodeAlign()<CR>
